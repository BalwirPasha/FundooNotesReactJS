import { Avatar, createMuiTheme, IconButton, Menu, MuiThemeProvider } from '@material-ui/core';
...
class Colournote extends Component {
  ...
  openPalette = (event) => {
    ...
    this.arr = this.colourArr.map((color, ind) => {
      return <Avatar key={ind} onClick={() => this.addColour(color)} style={{height:'25px', width:'25px', margin:'2px', backgroundColor:[color], border: '1px solid #dbdbdb'}}></Avatar>
    })
  }
